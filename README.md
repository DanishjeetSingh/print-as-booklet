...
The repository also contains an [iPhone app](ios/README.md) with a Share Extension. It can accept an article URL from the Substack share sheet, fetch the authenticated PDF, apply the same booklet formatting, and submit it directly to a remembered AirPrint printer through IPP.
